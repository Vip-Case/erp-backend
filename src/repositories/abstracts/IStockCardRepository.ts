...
export interface IStockCardRepository extends IBaseRepository<StockCard>{
    ...
    findAllStockCardAttributes(): Promise<StockCardAttribute[]>;
    ...
    findAllStockCardBarcodes(): Promise<StockCardBarcode[]>;
    ...
    findAllStockCardCategories(): Promise<StockCardCategory[]>
    ...
    findAllStockCardPriceLists(): Promise<StockCardPriceList[]>
    ...
    findAllStockCardTaxRates(): Promise<StockCardTaxRate[]>
    ...
    findAllStockCardVariants(): Promise<StockCardVariant[]>
    ...
    findAllStockCardImages(): Promise<IStockCardImage[]>
    ...
    findAllStockCardVideos(): Promise<IStockCardVideo[]>
