...
export const StockMovementController = {
  ...
  updateStockMovement: async (ctx: Context) => {
    ...
    const stockMovementData: Partial<StockMovement> =
      ctx.body as Partial<StockMovement>;

    if (!bearerToken) {
      return ctx.error(401, "Authorization header is missing.");
    }
    try {
      const stockMovement = await stockMovementService.updateStockMovement(
        id,
        stockMovementData,
        bearerToken
      );
  ...
  getAllOrderStockMovements: async (ctx: Context) => {
    try {
      const stockMovements =
        await stockMovementService.getAllOrderStockMovements();
      ctx.set.status = 200;
      return stockMovements;
    } catch (error: any) {
      ctx.set.status = 500;
  ...
  getAllOrderStockMovementsByStockCardId: async (ctx: Context) => {
    ...
    try {
      const stockMovements =
        await stockMovementService.getAllOrderStockMovementsByStockCardId(
          stockCardId
        );
      ctx.set.status = 200;
      return stockMovements;
  ...
  getAllSalesStockMovements: async (ctx: Context) => {
    try {
      const stockMovements =
        await stockMovementService.getAllSalesStockMovements();
      ctx.set.status = 200;
      return stockMovements;
    } catch (error: any) {
      ctx.set.status = 500;
  ...
  getAllSalesStockMovementsByStockCardId: async (ctx: Context) => {
    ...
    try {
      const stockMovements =
        await stockMovementService.getAllSalesStockMovementsByStockCardId(
          stockCardId
        );
      ctx.set.status = 200;
      return stockMovements;
  ...
  getAllPurchaseStockMovements: async (ctx: Context) => {
    try {
      const stockMovements =
        await stockMovementService.getAllPurchaseStockMovements();
      ctx.set.status = 200;
      return stockMovements;
    } catch (error: any) {
      ctx.set.status = 500;
  ...
  getAllPurchaseStockMovementsByStockCardId: async (ctx: Context) => {
    ...
    try {
      const stockMovements =
        await stockMovementService.getAllPurchaseStockMovementsByStockCardId(
          stockCardId
        );
      ctx.set.status = 200;
      return stockMovements;
  ...
  getAllStockMovementsByStockCardCode: async (ctx: Context) => {
    ...
    try {
      const stockMovements =
        await stockMovementService.getAllStockMovementsByStockCardCode(
          stockCardCode
        );
      ctx.set.status = 200;
      return stockMovements;
  ...
  getAllStockMovementsByStockCardId: async (ctx: Context) => {
    ...
    try {
      const stockMovements =
        await stockMovementService.getAllStockMovementsByStockCardId(
          stockCardId
        );
      ctx.set.status = 200;
      return stockMovements;
