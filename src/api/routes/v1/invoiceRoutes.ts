...
export const InvoiceRoutes = (app: Elysia) => {
  app.group("/invoices", (app) =>
    app.get("/", InvoiceController.getAllInvoices, { tags: ["Invoices"] })
      ...
      .post("/purchase/cancel", InvoiceController.cancelPurchaseInvoiceWithRelations, { tags: ["Invoices"] })
      ...
      .post("/sales/cancel", InvoiceController.cancelSalesInvoiceWithRelations, { tags: ["Invoices"] })
      ...
      .delete("/deleteQuickSaleInvoice/:id", InvoiceController.deleteQuickSaleInvoiceWithRelations, { tags: ["Invoices"] })
  );
  return app;
};
