...
export const WarehouseRoutes = (app: Elysia) => {
  app.group("/warehouses", (app) =>
    app
      .get("/", WarehouseController.getAllWarehouses, { tags: ["Warehouses"] })
      ...
      .get("/filter", WarehouseController.getWarehousesWithFilters, {
        tags: ["Warehouses"],
      })
      .post("/stocktake", WarehouseController.createStocktakeWarehouse, {
        tags: ["Warehouses"],
      })
      .post("/stocktake/:id", WarehouseController.updateStocktakeWarehouse, {
        tags: ["Warehouses"],
      })
      .get("/stocktake", WarehouseController.getAllStocktakeWarehouses, {
        tags: ["Warehouses"],
      })
      .get("/stocktake/:id", WarehouseController.getStocktakeWarehouseById, {
        tags: ["Warehouses"],
      })
      ...
      .get("/receipts/:id", WarehouseController.getReceiptById, {
        tags: ["Warehouses"],
      })
  );
  return app;
