...
export class AttributeService {
  ...
  constructor() {
    this.attributeRepository = new BaseRepository<StockCardAttribute>(
      prisma.stockCardAttribute
    );
  }

  async createAttribute(
    attribute: StockCardAttribute
  ): Promise<StockCardAttribute> {
    try {
  ...
  async updateAttribute(
    id: string,
    attribute: Partial<StockCardAttribute>
  ): Promise<StockCardAttribute> {
    try {
  ...
  async getAttributesWithFilters(
    filter: any
  ): Promise<StockCardAttribute[] | null> {
    try {
