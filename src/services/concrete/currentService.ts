...
export class currentService {
            ...
            data.addresses.map((address: CurrentAddress) =>
              tx.currentAddress.create({
                data: {
                  ...
                  current: {
                    connect: { currentCode: updatedCurrent.currentCode },
                  },
                },
              })
            )
  ...
  async getCurrentsWithFilters(
    filters: Partial<Prisma.CurrentWhereInput>
  ...
  async createCurrentWithRelations(
    data: {
      currentCode: string;
      currentName: string;
      currentType?: $Enums.CurrentType;
            ...
            data.currentRisk.map((currentRisk) =>
              prisma.currentRisk.create({
                data: {
                  ...
                  varsayilanSatisIskontosu:
                    currentRisk.varsayilanSatisIskontosu,
  ...
  async updateCurrentWithRelations(
    id: string,
    data: {
      current: Current;
