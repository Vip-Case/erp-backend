...
-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('BasitUrun', 'VaryasyonluUrun', 'DijitalUrun', 'Hizmet', 'VaryasyonUrun');
...
-- CreateEnum
CREATE TYPE "VaultType" AS ENUM ('DebtTransfer', 'ServiceChargeCollection', 'CompanyCreditCardWithdrawals', 'BuyingForeignCurrency', 'InputReceipt', 'BankWithdrawals', 'ReceivingValuableAssets', 'ReceivableTransfer', 'ServiceChargePayment', 'CompanyCreditCardDeposit', 'CurrencyExchange', 'LoanPayment', 'ExitReceipt', 'PaymentToBank', 'PreciousMetalExchange', 'LoanWithdrawal', 'ReceivedVirement', 'OutgoingVirement', 'InGoingVirement', 'POSWithdrawals', 'PurchaseInvoicePayment', 'SalesInvoicePayment', 'CashCollection', 'BankCollection', 'POSCollection');
...
CREATE TABLE "OrderItem" (
    ...
    "productColor" TEXT,
    "productOrigin" TEXT,
    "salesCampaignId" BIGINT,
    "merchantId" BIGINT,
    "amount" DECIMAL(15,2),
    "discount" DECIMAL(15,2),
    "tyDiscount" DECIMAL(15,2),
    "vatBaseAmount" DECIMAL(15,2),
    "currencyCode" TEXT,
    "sku" TEXT,
    "orderLineId" BIGINT,
...
CREATE TABLE "Store" (
    ...
    "autoInvoiceCreation" BOOLEAN NOT NULL DEFAULT false,
    "storeUrl" TEXT,
    "createdBy" TEXT,
    "updatedBy" TEXT,
